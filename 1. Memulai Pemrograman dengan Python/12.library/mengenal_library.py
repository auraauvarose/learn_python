...
Untuk melakukan instalasi library eksternal, Anda dapat melakukan beberapa cara, seperti menggunakan PIP dan conda.
    ...
    1. PIP adalah package manager yang digunakan untuk menginstal dan mengelola library atau paket Python. PIP merupakan singkatan dari “Pip Installs Packages”. PIP sudah terinstal secara otomatis ketika Anda menginstal Python versi 3.4 ke atas. Anda dapat melakukan instalasi library dengan menggunakan perintah berikut pada terminal atau command prompt.

pip install <nama_library>

    2. conda adalah package manager yang digunakan untuk mengelola paket dan lingkungan di Python. Conda merupakan bagian dari Anaconda Distribution, yang merupakan distribusi Python yang populer untuk analisis data dan ilmu data. Conda memungkinkan Anda untuk menginstal, memperbarui, dan menghapus paket dengan mudah, serta mengelola lingkungan virtual untuk proyek-proyek Python Anda. Anda dapat melakukan instalasi library dengan menggunakan perintah berikut pada terminal atau command prompt.
